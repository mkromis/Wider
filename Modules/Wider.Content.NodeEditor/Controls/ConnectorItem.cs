...
namespace Wider.Content.NodeEditor.Controls
{
    ...
    public class ConnectorItem : ContentControl
    {
        ...
        /// Static constructor.
        /// </summary>
        static ConnectorItem() => DefaultStyleKeyProperty.OverrideMetadata(typeof(ConnectorItem), new FrameworkPropertyMetadata(typeof(ConnectorItem)));
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            else if (isLeftMouseDown)
            {
                    ...
                    ParentNetworkView.EnableConnectionDragging)
                {
                    ...
                    //
                    Point curMousePoint = e.GetPosition(ParentNetworkView);
                    Vector dragDelta = curMousePoint - lastMousePoint;
                    ...
                    if (dragDistance > DragThreshold)
                    {
                        ...
                        //
                        ConnectorItemDragStartedEventArgs eventArgs = new ConnectorItemDragStartedEventArgs(ConnectorDragStartedEvent, this);
        ...
        /// </summary>
        private void ConnectorItem_LayoutUpdated(Object sender, EventArgs e) => UpdateHotspot();
