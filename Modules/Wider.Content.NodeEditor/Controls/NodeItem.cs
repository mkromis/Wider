...
namespace Wider.Content.NodeEditor.Controls
{
    ...
    public class NodeItem : ListBoxItem
    {
        ...
        public static readonly DependencyProperty ZIndexProperty =
            DependencyProperty.Register("ZIndex", typeof(Int32), typeof(NodeItem),
        ...
        public Int32 ZIndex
        {
            get => (Int32)GetValue(ZIndexProperty);
        ...
        /// </summary>
        private Boolean isLeftMouseAndControlDown = false;
        ...
        /// Static constructor.
        /// </summary>
        static NodeItem() => DefaultStyleKeyProperty.OverrideMetadata(typeof(NodeItem), new FrameworkPropertyMetadata(typeof(NodeItem)));
        ...
        internal void BringToFront()
        {
            ...
            Int32 maxZ = ParentNetworkView.FindMaxZIndex();
            ZIndex = maxZ + 1;
        }
