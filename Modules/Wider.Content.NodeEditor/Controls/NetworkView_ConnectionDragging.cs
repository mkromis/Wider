...
namespace Wider.Content.NodeEditor.Controls
{
    ...
    public partial class NetworkView
    {
        ...
        private void ConnectorItem_DragStarted(Object source, ConnectorItemDragStartedEventArgs e)
        {
            ...
            NodeItem nodeItem = draggedOutConnectorItem.ParentNodeItem;
            draggedOutNodeDataContext = nodeItem.DataContext ?? nodeItem;
            draggedOutConnectorDataContext = draggedOutConnectorItem.DataContext ?? draggedOutConnectorItem;
        ...
        private void ConnectorItem_Dragging(Object source, ConnectorItemDraggingEventArgs e)
        {
            ...
            //
            ConnectionDraggingEventArgs connectionDraggingEventArgs =
            ...
            Boolean dragOverSuccess = DetermineConnectorItemDraggedOver(mousePoint, out ConnectorItem connectorDraggedOver, out Object connectorDataContextDraggedOver);
            if (connectorDraggedOver != null)
            {
                ...
                //
                QueryConnectionFeedbackEventArgs queryFeedbackEventArgs =
        ...
        private void ConnectorItem_DragCompleted(Object source, ConnectorItemDragCompletedEventArgs e)
        {
            ...
            Point mousePoint = Mouse.GetPosition(this);
            DetermineConnectorItemDraggedOver(mousePoint, out ConnectorItem connectorDraggedOver, out Object connectorDataContextDraggedOver);
        ...
        /// </summary>
        private Boolean DetermineConnectorItemDraggedOver(Point hitPoint, out ConnectorItem connectorItemDraggedOver, out Object connectorDataContextDraggedOver)
        {
            ...
            ConnectorItem connectorItem = WpfUtils.FindVisualParentWithType<ConnectorItem>(hitItem);
            if (connectorItem == null)
            {
                return false;
            }

            NetworkView networkView = connectorItem.ParentNetworkView;
            if (networkView != this)
            {
                //
